...
- Tooling-first layout built with Node.js + TypeScript (ES modules via `tsx`):
  ...
  - `package.json` + `tsconfig.json`: minimal tooling configuration; strict TypeScript enabled.
...
- Testing: no automated tests yet; builds serve as basic validation.

## Project documentation
- No dedicated `.doc/`, `.spec/`, `doc/`, or `spec/` directories present.
- Reference docs: `README.md` describes setup, build, deploy, and configuration.
